...
/* package SpokeCalculator-0.1.0.0 */
#ifndef VERSION_SpokeCalculator
#define VERSION_SpokeCalculator "0.1.0.0"
#endif /* VERSION_SpokeCalculator */
#ifndef MIN_VERSION_SpokeCalculator
#define MIN_VERSION_SpokeCalculator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_SpokeCalculator */
