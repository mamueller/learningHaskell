...
import OriginalFuncs

main :: IO ()
main = do
  defaultMain (testGroup "Testing the original versions of the factorial function and the function computing the n-th fibonachi number" [ factorial,fibonacci_0,fibonacci_1 ,fibonacci_2])
...
fibonacci_2= testCase "Testing fibonacci"
  (assertEqual "fib 2 should say 0+1."  1 (fib  2))
